...
for (const icon of animatedIcons) {
  fileContent += `export const ${icon} = withAutoAnimate(AnimatedIcons.${icon}Icon);\n`;
}

fs.writeFileSync('src/lib/icons.ts', fileContent, 'utf8');
console.log('Generated src/lib/icons.ts');
