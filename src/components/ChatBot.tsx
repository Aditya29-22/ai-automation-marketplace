...
export default function ChatBot() {
  const { isChatOpen, setChatOpen, chatMessages, addChatMessage, addToCart } = useStore();
  const { navigate: setCurrentPage, navigateToProduct } = useNavigation();
                      ...
                      <div className="flex gap-2.5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex gap-1.5 mt-2">
                            <button
                              onClick={() => { navigateToProduct(p.id); setChatOpen(false); }}
