...
const content = `export const COUNTRY_CODES = ${JSON.stringify(countries, null, 2)};\n`;
fs.writeFileSync('/Users/vineetcres/Desktop/Github/ai-automation-marketplace/src/data/countryCodes.ts', content);
